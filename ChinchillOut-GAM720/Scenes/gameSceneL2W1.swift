...
class GameSceneL2W1: SKScene {
    ...
    var sceneManagerDelegateL2: SceneManagerDelegateL2?
    
    init(size: CGSize, sceneManagerDelegateL2: SceneManagerDelegateL2) {
  
        
        self.levelKey = "Level_0-2"
        self.sceneManagerDelegateL2 = sceneManagerDelegateL2
    ...
    func createAndShowPopup(type: Int, title: String) {
        ...
        default:
            ...
            // FAILED, COMPLETED
            popup = ScorePopupNode(buttonHandlerDelegate: self, title: title, level: "Level_0-2", texture: SKTexture(imageNamed: GameConstants.StringConstants.largePopup), score: fruits, fruits: superFruits, animated: true)
    ...
    func finishGame() {
        ...
        ScoreManager.compare(scores: [scores], in: "Level_0-2")
...
extension GameSceneL2W1: SKPhysicsContactDelegate {
...
extension GameSceneL2W1: PopupButtonHandlerDelegate {
    ...
    func popupButtonHandler(index: Int) {
        ...
        case 0:
            popup!.run(SKAction.fadeOut(withDuration: 0.2)) {
                ...
                self.sceneManagerDelegateL2?.presentMenuViewController()
        ...
        case 2:
            ...
            popup!.run(SKAction.fadeOut(withDuration: 0.2)) {
                ...
                self.sceneManagerDelegateL2?.presentW1L2Scene()
