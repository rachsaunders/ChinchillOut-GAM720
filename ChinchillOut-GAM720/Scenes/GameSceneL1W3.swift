...
class GameSceneL1W3: SKScene {
    ...
    var sceneManagerDelegateXmas: SceneManagerDelegateXmas?
    
    init(size: CGSize, sceneManagerDelegateXmas: SceneManagerDelegateXmas) {
     
        self.levelKey = "Level_2-1"
        self.sceneManagerDelegateXmas = sceneManagerDelegateXmas
    ...
    func createAndShowPopup(type: Int, title: String) {
        ...
        default:
            ...
            popup = ScorePopupNode(buttonHandlerDelegate: self, title: title, level: "Level_2-1", texture: SKTexture(imageNamed: GameConstants.StringConstants.largePopup), score: fruits, fruits: superFruits, animated: true)
    ...
    func finishGame() {
        ...
        ScoreManager.compare(scores: [scores], in: "Level_2-1")
...
extension GameSceneL1W3: SKPhysicsContactDelegate {
...
extension GameSceneL1W3: PopupButtonHandlerDelegate {
    ...
    func popupButtonHandler(index: Int) {
        ...
        case 0:
            popup!.run(SKAction.fadeOut(withDuration: 0.2)) {
                ...
                self.sceneManagerDelegateXmas?.presentMenuViewController()
        ...
        case 2:
            ...
            popup!.run(SKAction.fadeOut(withDuration: 0.2)) {
                ...
                self.sceneManagerDelegateXmas?.presentW3L1Scene()
