...
enum HalloweenGameStateL2 {
    case ready, ongoing, paused, finished
}

class GameSceneL2W2: SKScene {
    ...
    var sceneManagerDelegateHalloweenL2: SceneManagerDelegateHalloweenL2?
    
    init(size: CGSize, sceneManagerDelegateHalloweenL2: SceneManagerDelegateHalloweenL2) {
     
        self.levelKey = "Level_1-2"
        self.sceneManagerDelegateHalloweenL2 = sceneManagerDelegateHalloweenL2
    ...
    func createAndShowPopup(type: Int, title: String) {
        ...
        default:
            ...
            popup = ScorePopupNode(buttonHandlerDelegate: self, title: title, level: "Level_1-2", texture: SKTexture(imageNamed: GameConstants.StringConstants.largePopup), score: fruits, fruits: superFruits, animated: true)
    ...
    func finishGame() {
        ...
        ScoreManager.compare(scores: [scores], in: "Level_1-2")
...
extension GameSceneL2W2: SKPhysicsContactDelegate {
...
extension GameSceneL2W2: PopupButtonHandlerDelegate {
    ...
    func popupButtonHandler(index: Int) {
        ...
        case 0:
            popup!.run(SKAction.fadeOut(withDuration: 0.2)) {
                ...
                self.sceneManagerDelegateHalloweenL2?.presentMenuViewController()
        ...
        case 2:
            ...
            popup!.run(SKAction.fadeOut(withDuration: 0.2)) {
                ...
                self.sceneManagerDelegateHalloweenL2?.presentW2L2Scene()
